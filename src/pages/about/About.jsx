        ...
        <div className="flex justify-center items-center  pt-[32px]">
          <div className="flex flex-wrap lg:flex-row items-center gap-10 md:gap-6 lg:space-x-[92px]">
            <span className="flex items-center gap-2">
              ...
              <h2 className="text-[#535862] font-semibold font-Poppins">Crowdcube.com</h2>
            </span>
            ...
            <span className="flex items-center gap-2">
              ...
              <h2 className="text-[#535862] font-semibold font-Poppins">Ukbaa.org.uk</h2>
            </span>
            ...
            <span className="flex items-center gap-2">
              ...
              <h2 className="text-[#535862] font-semibold font-Poppins">Capitalism.com</h2>
            </span>
